        ...
        <React.Fragment>
            ...
            <div className="row animated fadeIn">
                ...
                <div className="col-md-4 stretch-card grid-margin">
                    ...
                    <div className="card-body">
                        <img src="/assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
                        <h4 className="font-weight-normal mb-3">New Booking <i className="mdi mdi-calendar-text mdi-24px float-right"></i>
                        </h4>
                ...
                <div className="col-md-4 stretch-card grid-margin">
                    ...
                    <div className="card-body">
                        <img src="/assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
                        <h4 className="font-weight-normal mb-3">New Booking This Month <i className="mdi mdi-calendar-multiple-check mdi-24px float-right"></i>
                        </h4>
              ...
              <div className="col-12 grid-margin">
                <div className="card">
                    <div className="card-body animated fadeIn">
                        <h4 className="card-title">Recent Registered Users</h4>
